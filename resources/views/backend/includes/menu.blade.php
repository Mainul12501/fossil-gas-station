...
{{--                </li>--}}
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('basic-settings.create') }}" aria-expanded="false"><i class="mdi mdi-calendar"></i><span class="hide-menu">Site Settings</span></a>
                </li>
{{--                <li class="sidebar-item">--}}
